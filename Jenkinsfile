...
emailext (
	...
	vjgjgvjvgjjk
  	<h2>${BUILD_LOG_REGEX, regex="Lock released on resource [testinglock2_TestBoga]", linesBefore=0, linesAfter=15, maxMatches=1, showTruncatedLines=false, escapeHtml=true}</h2>
